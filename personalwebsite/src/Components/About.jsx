...
export default function AboutMe() {
  ...
  const newGoalState = ` 
  My goals are clear: I aspire to be a software engineer who creates meaningful impact through technology. I am passionate about 
  building solutions that improve lives—whether advancing healthcare or developing tools that simplify everyday challenges. I am also 
  driven to honor my parents’ unwavering support by striving for success and making a positive impact in the world
  `;
  ...
  function gitHubBtn() {
    window.location.href = "https://github.com/TheDonRay?tab=repositories";
  }
    ...
    <div className="cards-container">
      ...
      <div className="about-me-card">
        ...
        <p className="paragraph-Color">
          {originalText}
          <button className="button1" onClick={changeForClient}>
            Who is Rayat?😄
          </button>
      ...
      <div className="hobbydiv">
        ...
        <button onClick={hobbyButton} className="hobbybtn">
          Hobbies 🤖
        </button>
        <button onClick={closeHobbyButton} className="hobbyclose-btn">
          Close
        </button>
      </div>
      ...
      <div className="GoalsCard">
        ...
        <p className="paragraphtextforGoals">
          {origGoaltext}
          <button onClick={goalsCard} className="goalsbtn">
            Goals 💫
          </button>
          <button onClick={closeGoalCard} className="goalsclose-btn">
            Close
          </button>
        </p>
      </div>

      <button onClick={gitHubBtn} className="github-page">
